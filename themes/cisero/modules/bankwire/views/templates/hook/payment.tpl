...
<p class="payment_module p-4 bg-light">
  <a href="{$link->getModuleLink('bankwire', 'payment')|escape:'htmlall':'UTF-8'}" title="{l s='Pay by bank wire' mod='bankwire'}">
    <img class="me-4" src="{$module_dir|escape:'htmlall':'UTF-8'}bankwire.jpg" alt="{l s='Pay by bank wire' mod='bankwire'}" width="86" height="49"/>
