            ...
            <div class="delivery_options">
              {foreach $option_list as $key => $option}
                <div class="table_block">
                    <table class="resume align-middle table{if !$option.unique_carrier} hide{/if}">
                      <tr>
                        <td class="delivery_option_radio text-center">
...
{if !$opc}
  <p class="cart_navigation d-grid gap-2 d-md-flex justify-content-md-between mt-4">
    <input type="hidden" name="step" value="3">
    <input type="hidden" name="back" value="{$back}">
    {if !$is_guest}
      {if $back}
        <a href="{$link->getPageLink('order', true, NULL, "step=0&back={$back}{if $multi_shipping}&multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn btn-lg btn-outline-dark">
          <i class="fa fa-chevron-left"></i>
          {l s='Continue shopping'}
        </a>
      {else}
        <a href="{$link->getPageLink('order', true, NULL, "step=0{if $multi_shipping}&multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn btn-lg btn-outline-dark">
          <i class="fa fa-chevron-left"></i>
          {l s='Continue shopping'}
        </a>
      {/if}
    {else}
      <a href="{$link->getPageLink('order', true, NULL, "{if $multi_shipping}multi-shipping={$multi_shipping}{/if}")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn btn-lg btn-outline-dark">
        <i class="fa fa-chevron-left"></i>
        {l s='Continue shopping'}
      </a>
    {/if}
    {if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}
      <button type="submit" name="processCarrier" class="btn btn-lg btn-dark standard-checkout">
        <span>
  ...
  {if !$opc}
    <div id="ordermsg" class="form-group">
       <label class="form-label">{l s='If you would like to add a comment about your order, please write it in the field below.'}</label>
