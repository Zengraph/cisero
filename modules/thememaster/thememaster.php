...
class thememaster extends Module
{
    ...
    public function install()
    {
        ...
        $hooksToInstall = ['displayHeader', 'displayHome', 'displayBanner', 'displayTop', 'displayNav'];
		...
		Configuration::updateValue('TM_LANGUAGE_TOP_DISPLAY', '0');
		Configuration::updateValue('TM_CURRENCY_TOP_DISPLAY', '0');
    ...
    public function uninstall()
    {
        $keysToDrop = [
			...
			'TM_LANGUAGE_TOP_DISPLAY',
			'TM_CURRENCY_TOP_DISPLAY',
...
';
	...
	// Show or Hide the currencies and languages selector on top right of website
		$showlanguagetop = Configuration::get('TM_LANGUAGE_TOP_DISPLAY');
		$showcurrencytop = Configuration::get('TM_CURRENCY_TOP_DISPLAY');
		if ($showlanguagetop < 1) $css .= '#languages_block_top{display:none;}';
		if ($showcurrencytop < 1) $css .= '#currencies_block_top{display:none;}';
...
// enf of sticky menu
	...
	protected function getOptionFieldsHeader()
    {
        return [
			...
			'TM_LANGUAGE_TOP_DISPLAY' => [
                'title' => $this->l('Show languages block on header / top position'),
				'desc'  => $this->l('On desktop mode, it will show the language selector in header.'),
                'cast'  => 'boolval',
                'type'  => 'bool',
            ],
			'TM_CURRENCY_TOP_DISPLAY' => [
                'title' => $this->l('Show currencies block on header / top position'),
				'desc'  => $this->l('On desktop mode, it will show the currencies selector in header.'),
                'cast'  => 'boolval',
                'type'  => 'bool',
            ],
		];
